	...
	public class MainActivity : Activity
	{
		...
		protected override void OnCreate (Bundle bundle)
		{
			...
			if (FragmentManager.BackStackEntryCount == 0) {
                ...
                loginFragment.LoginSucceeded += () => ShowProduct();
				//productFragment.ProductSelected += ShowProductDetail;

				baseFragment = loginFragment.Id;
				SwitchScreens (loginFragment, false, true);
			}
		}
        ...
        {
            var productVc = new ProductListFragment();
            var productDetailsVc = new ProductDetailsFragment();
            productVc.ProductSelected += ShowProductDetail;
            SwitchScreens(productVc); 
